/* ============================================================
   ...
   Materia: Páginas Web | Estudiante: Santiago Jiménez Sombra
   Año: 2026
   ============================================================ */
...
function updateBPMDisplay() {
  ...
  if (el) {
    ...
    /* Color según rango */
    if      (currentBPM < 60) el.style.color = '#00d4ff';  // Bradicardia
    else if (currentBPM > 100) el.style.color = '#ff4757'; // Taquicardia
    else                       el.style.color = '#00ff88'; // Normal
  }
}
